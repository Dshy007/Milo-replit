/**
 * Claude Scheduler - DISABLED
 *
 * Original file moved to: server/disabled/claude-scheduler.ts.bak
...
export async function optimizeWithClaude(
  ...
  console.warn("[Claude Scheduler] DISABLED - pending sklearn replacement");
  return {
    suggestions: [],
    unassigned: [],
    stats: {
...
export async function applyClaudeSchedule(
  ...
  return {
    applied: 0,
    errors: ["Claude Scheduler disabled - pending sklearn replacement"],
  };
}
