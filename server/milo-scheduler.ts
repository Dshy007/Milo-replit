/**
 * Milo Scheduler - DISABLED
 *
 * Original file moved to: server/disabled/milo-scheduler.ts.bak
...
export async function optimizeWithMilo(
  ...
  console.warn("[Milo Scheduler] DISABLED - pending sklearn replacement");
  return {
    suggestions: [],
    unassigned: [],
    stats: {
...
export async function applyMiloSchedule(
  ...
  return {
    applied: 0,
    errors: ["Milo Scheduler disabled - pending sklearn replacement"],
  };
}
